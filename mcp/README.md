...
omitted filters leave the room read unchanged. The HTTP filters require the service-side
change in #190; until that lands, the wrapper cannot guarantee filtered results.
