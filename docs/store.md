...
- `clean_text(text: str, limit: int = 4096) -> str` — Replace every INVISIBLE_CATEGORIES character and every SWEEP_ALSO codepoint with a
...
- `sweep_invisibles(text: str) -> str` — Every INVISIBLE_CATEGORIES character and every SWEEP_ALSO codepoint to a space.
