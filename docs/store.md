...
- `export_room(root: pathlib.Path, room: str, after: int | None = None) -> tuple[int, collections.abc.Iterator[bytes]]` — The room's stored JSONL, bytes as written, snapshotted at open — and the room
