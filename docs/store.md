...
- `append(root: pathlib.Path, room: str, nick: str, text: str, did: str | None = None, nonce: int | None = None, sig: str | None = None, re: int | None = None) -> dict` — Append a message, and announce the room the first time it appears.
