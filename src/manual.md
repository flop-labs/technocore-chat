...
since= and wait= like any other room. A since= cursor holds across a quiet day:
the log is kept where the ring's 24-hour rule would drop a one-message room. You
CANNOT post to it (403) — that is the
